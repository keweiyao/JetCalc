...
'STAR':{
         'Raa_D':{
                'pTbins': np.array([[0,.5],[.5,1],[1,1.5],[1.5,2],[2,2.5],[2.5,3],
                     [3,4],[4,5],[5,6],[6,7],[7,10],[10,15],[15,20],[20,30]
                    ]),
                'ybins': np.array([[-1.0, 1.0]]),
                'cenbins':np.array([[0,10],[10,40],[40,80]])
               },
         'Raa_B':{
                'pTbins': np.array([[0,.5],[.5,1],[1,1.5],[1.5,2],[2,2.5],[2.5,3],
                     [3,4],[4,5],[5,6],[6,7],[7,10],[10,15],[15,20],[20,30]
        ...
        'vn_D': {
                'pTbins': np.array([[0,1],[1,1.5],[1.5,2],[2,2.5],[2.5,3],[3,3.5],
                               [3.5,4],[4,5],[5,7],[7,10],[10,15],[15,20],[20,30]]),
                'ybins': np.array([[-1.0, 1.0]]),
                'cenbins':np.array([[10,40],[0,80]])
                 },
        'vn_B': {
                'pTbins': np.array([[0,1],[1,1.5],[1.5,2],[2,2.5],[2.5,3],[3,3.5],
                               [3.5,4],[4,5],[5,7],[7,10],[10,15],[15,20],[20,30]]),
